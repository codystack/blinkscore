                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="footer-widget footer-col-1 wow fadeInUp" data-wow-delay=".1s">
                                    <div class="footer-logo">
                                        <a href="./">
                                            <img src="./assets/images/logo_light.svg" alt="Logos">
                                        </a>
                                    </div>
                                    <div class="footer-text">
                                        <p>BlinksCore is a trusted financial company based in Lagos, Nigeria, specializing in providing Proof of Funds and Employment Salary History services.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                            ...
                            <div class="col-12">
                                <div class="copyright-content-area">
                                    <div class="copyright-text">
                                        <p>© <script>document.write(new Date().getFullYear());</script> BlinksCore. All right reserved. Built by <a href="https://webify.com.ng" target="_blank">Webify</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
